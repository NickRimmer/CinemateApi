...
{
    public class AccountMovieBoxResponseModel
    {
        [JsonProperty("moviebox")]
        [JsonConverter(typeof(FixJsonListsConverter<AccountMovieBoxModel>))]
        public List<AccountMovieBoxModel> MovieBox;  
    }
}